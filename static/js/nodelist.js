	$(function(){
        ...
        success:function(data){
        	...
        	if(data.statue=="1") {
				for (var j = 0; j < data.shownode.length; j++) {
					...
					temp_td2.innerText = data.shownode[j][0];
					temp_td3.innerText = data.shownode[j][1];
					temp_td4.innerText = data.shownode[j][2];
					temp_td5.innerText = data.shownode[j][3];
					temp_td6.innerText = data.shownode[j][4];
					temp_td7.innerText = data.shownode[j][5];
    ...
    return false;
					...
					//alert("into end");
					$("#nodeshow").find("tbody").append(temp_tr);
				}
			}
		}
		});
