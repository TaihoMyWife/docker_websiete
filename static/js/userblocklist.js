        ...
        success:function(data){
        	...
        	if(data.statue=="1") {
				for (var j = 0; j < data.userregister1.length; j++) {
					...
					//alert("into end");
					$("#userblockshow").find("tbody").append(temp_tr);
				}
			}
		}
		});
